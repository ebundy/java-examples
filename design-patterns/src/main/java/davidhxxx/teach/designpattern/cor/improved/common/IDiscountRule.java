...
public interface IDiscountRule extends IDiscountPrct {
	...
	/**
	 * It's the business rule. must not be called by the client. It's called by applyRoot
	 * 
	...
	/**
	 * It's the chain rule processing must be called by the client. It's the outer apply to process the whole rule chain
	 * 
	 * @param inputDataForDiscountRules
	 * @return
	 */
